...
export const EXAMPLES: { key: string; label: string; schema: Schema }[] = [
  {
    ...
    schema: {
      ...
      components: [
        ...
        { id: "N", type: "force", at: { ref: "bloc.cog" }, vector: { dx: -Math.sin(Math.PI / 6) * 1.0, dy: Math.cos(Math.PI / 6) * 1.0 }, label: "N", style: { stroke: "hsl(210, 80%, 60%)" } },
        { id: "f", type: "force", at: { ref: "bloc.cog" }, vector: { dx: -Math.cos(Math.PI / 6) * 0.6, dy: -Math.sin(Math.PI / 6) * 0.6 }, label: "f", style: { stroke: "hsl(280, 70%, 60%)" } },
  ...
  },
  {
    ...
    schema: {
      ...
      components: [
        ...
        { id: "plan", type: "incline", anchor: { ref: "sol.surface", t: 0.2 }, params: { angle: 35, length: 3.5, thickness: 0.05 } },
  ...
  },
  {
    ...
    schema: {
      ...
      components: [
        { id: "support", type: "wall", at: { x: 1, y: 3.5 }, params: { height: 0.05, thickness: 0.05 } },
  ...
  },
  {
    ...
    schema: {
      ...
      components: [
        ...
        { id: "mur", type: "wall", at: { x: 0.2, y: 0 }, params: { height: 1.5, thickness: 0.05 } },
